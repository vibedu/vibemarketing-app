...
const SYNC_KINDS = ['vendor', 'supplier', 'order', 'payment', 'vehicle', 'staff', 'advance', 'creditnote', 'expense', 'payrun', 'pettytopup', 'fuelcard', 'fueltxn', 'followup', 'tallymark', 'voucher', 'filing'];
